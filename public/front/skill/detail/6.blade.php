...
@section('title', 'マリノアシティ福岡 フクスケ アウトレット（SC接客ロールプレイングコンテスト特訓会）| SHOP STAFF LEARNING')
@section('description', 'マリノアシティ福岡 フクスケ アウトレットの接客スタイルを公開！')
...
?>
  ...
  <article class="skill-detail">
    <header class="skill-detail-title">
      <div class="photo"><p><img src="/front/images/skill/img06.jpg" alt="SC接客ロールプレイングコンテス2016特訓会"></p></div>
      <div class="text">
    ...
    <div class="detail-entry">
      ...
      <div class="entry-movie">
        ...
        <div class="movie">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/de9De7JYw2E" frameborder="0" allowfullscreen></iframe>
        </div>
      <!-- /.entry-movie --></div>
    <!-- /.detail-entry --></div>
  <!-- /.detail --></article>
